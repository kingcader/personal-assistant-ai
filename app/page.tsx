    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-3 mb-8">
          ...
          <Link
            href="/chat"
            className="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg border border-purple-500 hover:from-purple-700 hover:to-blue-700 shadow-sm transition-all"
          >
            ...
            <div className="flex-1">
              <div className="font-medium text-white">Chat with Assistant</div>
              <div className="text-sm text-white/80">Ask questions, get answers, draft emails</div>
            </div>
